...
app.get('/measurement', async (req,res) => {
    try {
        ...
        console.log("getting measurement from database successfully")
    } catch (error) {
...
app.get('/device', function(req,res) {
    try {
        ...
        console.log("getting devices from database successfully")
    } catch (error) {
...
startDatabase().then(async() => {
    ...
    try {
        ...
        console.log("error creating devices in database", error)
    }
